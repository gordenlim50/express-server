...
# Steps Constant
cct_steps = [500, 500, -500, 300, 200 ]
plux_steps = [20, -50, 50, 20, 30]
cct_i = 0
plux_i = 0

# Time step Constant
time_steps_minutes = [2, 3, 2, 3, 2, 1]      # Step in minutes
time_step_i = 0
...
print('Initial_CCT: ', target2)
print('Initial_Plux: ', target1)
...
while True:
    ...
    if elapsed_time >= time_step:
        if not adjust_targets:
            ...
            print('Plux_Measured: ', Plux_Measured)
